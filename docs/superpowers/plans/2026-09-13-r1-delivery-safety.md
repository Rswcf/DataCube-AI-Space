...
4. **Verify, recording each result in the ledger:**
   ...
   7. The founder subscribes a test address on the site; a Beehiiv confirmation email arrives (double opt-in).
   ...
   9. Optional, only with the founder's consent: one-click unsubscribe of the founder's own subscribed address from the mail client; Beehiiv shows it unsubscribed.
